              ...
              <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                <div className="w-full relative">
                  ...
                  {user?.emailVerification === false && (
                    <button
                      type="button"
                      className="absolute bottom-5 right-3 font-semibold text-blue-500 transition-all active:text-blue-700 active:translate-y-1"
                    >
                      Verify
                    </button>
                  )}
                ...
                <div className="w-full relative">
                  <h3 className="dark:text-gray-300 mb-2">Mobile No.</h3>
                  <input
                    type="tel"
                    name="phone"
                    ...
                    className="text-grey p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                  />
                  <button className="absolute bottom-5 right-3 font-semibold text-blue-500 transition-all active:text-blue-700 active:translate-y-1">
                    Verify
                  </button>
                </div>
              </div>
